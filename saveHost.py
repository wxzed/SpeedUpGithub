...
def write_system_hosts(hosts_content: str):
    print(hosts_content)
    with open("C:\Windows\System32\drivers\etc\hosts", "w") as fb:
        fb.write(hosts_content)
...
def main():
    ...
    has_change = write_system_hosts(hosts_content)
